        ...
        <div className="space-y-4">
          ...
          <Button size="lg" className="w-full bg-white text-black hover:bg-white/90" onClick={() => handleOAuthSignIn('apple')} disabled={isSigningIn}>
            <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12.02,2.02c-1.33-0.03-2.67,0.44-3.79,1.39C7.02,4.42,6.1,5.85,5.78,7.46c-0.09,0.47,0.24,0.91,0.72,0.99 c0.48,0.08,0.92-0.24,1-0.71c0.03-0.18,0.06-0.35,0.1-0.52c0.47-1.2,1.57-2.01,2.9-2.21c1.33-0.2,2.7,0.09,3.73,0.9 c0.13,0.1,0.25,0.22,0.36,0.34c-1.58,0.94-2.58,2.67-2.55,4.52c0.03,2.01,1.2,3.8,2.94,4.64c0.23,0.11,0.47,0.21,0.71,0.29 c-0.25,0.44-0.52,0.86-0.81,1.26c-0.79,1.08-1.74,2.03-2.92,2.66c-1.2,0.64-2.58,0.9-3.93,0.75c-1.4-0.15-2.73-0.72-3.8-1.62 c-0.4-0.33-0.97-0.23-1.3,0.18c-0.33,0.4-0.22,0.97,0.18,1.3c1.3,1.1,2.89,1.8,4.59,2.01c1.7,0.21,3.45-0.02,5.06-0.69 c1.58-0.66,2.98-1.76,4.05-3.18c0.05-0.07,0.1-0.14,0.15-0.21c-0.1,0.02-0.19,0.04-0.28,0.05c-1.5,0.17-3.04-0.65-3.86-1.92 c-0.57-0.88-0.8-1.93-0.64-2.98c0.15-1.05,0.7-2.02,1.52-2.75c0.55-0.49,1.2-0.86,1.9-1.09c0.7-0.23,1.41-0.23,2.1,0 c0.04,0.01,0.08,0.02,0.12,0.04c-0.08-0.44-0.22-0.86-0.43-1.25c-0.86-1.58-2.33-2.7-4.1-3.08C13.51,7.77,12.76,7.8,12.02,8.02z M17.06,11.02c-0.29-0.02-0.58-0.02-0.86,0.02c-1.23,0.17-2.28,0.89-2.86,1.96c-0.54,1.01-0.67,2.2-0.34,3.31 c0.33,1.11,1.13,2.01,2.21,2.48c1.08,0.47,2.3,0.43,3.35-0.12c1.05-0.55,1.82-1.53,2.15-2.67c0.01-0.05,0.02-0.09,0.03-0.14 c-1.08,0.14-2.18-0.22-2.9-0.96c-0.72-0.74-1.08-1.76-0.97-2.81c0.05-0.46-0.28-0.88-0.74-0.95C17.11,11.04,17.08,11.03,17.06,11.02z"></path>
            </svg>
            Continue with Apple
          </Button>
