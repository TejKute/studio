        ...
        <div className="space-y-4">
          ...
          <Button size="lg" className="w-full bg-black text-white hover:bg-black/90" onClick={() => handleOAuthSignIn('apple')} disabled={isSigningIn}>
              <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M17.6,12.2c-0.4,1.2-1.3,2.4-2.4,2.4c-0.8,0-1.5-0.6-2.4-0.6c-0.9,0-1.8,0.6-2.6,0.6c-1,0-2-0.8-2.9-2.1 c-1.4-2-2.3-4.9-1.2-7.8c0.8-2.1,2.5-3.5,4.5-3.5c0.9,0,1.8,0.5,2.4,0.5c0.6,0,1.6-0.5,2.8-0.5c2.1,0,3.7,1.3,4.6,3.3 c-1.6,1-2.7,2.7-2.7,4.6C15.3,10,16.1,11.2,17.6,12.2 M15.1,0.6c-1.4,0.1-2.9,0.9-3.7,0.9c-0.9,0-2.3-0.9-3.9-0.8 C4.7,0.7,2.5,2.6,1.4,5.3C-0.7,10.6,0.8,16.4,3,19.3c1.1,1.5,2.4,3,4.1,3c1.5,0,2-0.9,3.9-0.9c1.9,0,2.4,0.9,4,0.9 c1.8,0,3-1.4,4.1-2.9c1.2-1.7,1.8-3.5,1.9-3.6c-0.1,0-3.3-1.3-3.3-5.1c0-3.2,2.5-4.8,2.7-4.9c-1.3-2-3.1-2.4-3.8-2.4 C16.5,3.4,15.6,0.5,15.1,0.6"></path>
              </svg>
            Continue with Apple
          </Button>
